...
test("SongAI Landing Page", async ({ page }) => {
  ...
  await expect(landing.heroBodyCopy).toBeVisible();
  ...
  await expect(landing.heroCreateBtn).toBeVisible();
  ...
  await expect(landing.heroWatchLink).toBeVisible();
  ...
  await expect(landing.songCardsTapLabel).toBeVisible();
  console.log("Tap any song label is visible");

  await expect(landing.songCardFirst).toBeVisible();
  console.log("First song card is visible");

  await expect(landing.songCardFirstImage).toBeVisible();
  console.log("First song card image is visible");

  await expect(landing.songCardFirstTitle).toBeVisible();
  ...
  await expect(landing.howItWorksSubcopy).toBeVisible();
  console.log("How It Works subcopy is visible");

  await expect(landing.howItWorksNoBold).toBeVisible();
  console.log("No music experience needed text is visible");

  await expect(landing.howStep01Title).toBeVisible();
  console.log("Step 1 title is visible");

  await expect(landing.howStep01Desc).toBeVisible();
  console.log("Step 1 description is visible");

  await expect(landing.howStep02Title).toBeVisible();
  console.log("Step 2 title is visible");

  await expect(landing.howStep02Desc).toBeVisible();
  console.log("Step 2 description is visible");

  await expect(landing.howStep03Title).toBeVisible();
  console.log("Step 3 title is visible");

  await expect(landing.howStep03Desc).toBeVisible();
  console.log("Step 3 description is visible");

  await expect(landing.howStep04Title).toBeVisible();
  ...
  await expect(landing.giftHeading).toBeVisible();
  ...
  await expect(landing.giftPkgOriginalLabel).toBeVisible();
  console.log("Original Song label is visible");

  await expect(landing.giftPkgAlbumLabel).toBeVisible();
  console.log("Album Artwork label is visible");

  await expect(landing.giftPkgAlbumDesc).toBeVisible();
  ...
  await expect(landing.testimonialsHeading).toBeVisible();
  console.log("Testimonials heading is visible");

  await expect(landing.testimonialsMainText).toBeVisible();
  console.log("Testimonials main quote text is visible");

  await expect(landing.testimonialsTheSong).toBeVisible();
  console.log("Testimonials the song text is visible");

  await expect(landing.testimonialsAnniversary).toBeVisible();
  console.log("Anniversary tag is visible");

  await expect(landing.testimonialsGraduation).toBeVisible();
  ...
  await expect(landing.pricingMostPopular).toBeVisible();
  console.log("Most Popular badge is visible");

  await expect(landing.plan1Title).toBeVisible();
  console.log("Plan 1 title is visible");

  await expect(landing.plan1Price).toBeVisible();
  console.log("Plan 1 price is visible");

  await expect(landing.plan2Title).toBeVisible();
  console.log("Plan 2 title is visible");

  await expect(landing.plan2CTA).toBeVisible();
  console.log("Plan 2 CTA is visible");

  await expect(landing.plan3Title).toBeVisible();
  ...
  await expect(landing.faqQuestion1).toBeVisible();
  console.log("FAQ question 1 is visible");

  await expect(landing.faqQuestion2).toBeVisible();
  console.log("FAQ question 2 is visible");

  await expect(landing.faqQuestion3).toBeVisible();
  console.log("FAQ question 3 is visible");

  await expect(landing.faqQuestion4).toBeVisible();
  console.log("FAQ question 4 is visible");

  await expect(landing.faqQuestion5).toBeVisible();
  console.log("FAQ question 5 is visible");

  await expect(landing.faqQuestion6).toBeVisible();
